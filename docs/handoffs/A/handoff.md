...
- A PR #7 currently points at a4005517d2d8cfab12aae87c248ef682ab4e96a4. This contains the fix for an extra closing delimiter in the repeated-restart test that the clean integrated build exposed. Compare reports 18 commits ahead and 0 behind integration/v1; GitHub's PR metadata currently says mergeable: false, so do not merge until that inconsistency is resolved. No PR comments/reviews or status checks/workflow runs were returned at this audit.
