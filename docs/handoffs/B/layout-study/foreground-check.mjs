...
const paths = ['src/render/index.ts', 'src/render/deformation.ts', 'src/render/ram.ts', 'public/assets/textures/workshop-v4.webp',
...
const report = { checkedAt: new Date().toISOString(), kind: 'Actual WebGL production renderer with synthetic stored-history fixtures. CPU projection of actual deformed GLB vertices; not physical case containment, C HUD, gameplay or iPhone validation.', sourceHashesBefore: hashes(), layouts: [], captures: [] };
